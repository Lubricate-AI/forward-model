"""Shared observation model base class."""
...
class ObservationModel(BaseModel, frozen=True):
    """Shared base class for all forward models.
    ...
    def validate_no_body_overlap(self) -> "ObservationModel":
